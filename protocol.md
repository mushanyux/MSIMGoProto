...
规定：第八位（最高位）若为1，则表示还有后续字节存在。

最多允许4个字节表示剩余长度。最大长度为：0xFF,0xFF,0xFF,0x7F，二进制表示为:11111111,11111111,11111111,01111111，十进制：268435455 byte=261120KB=256MB=0.25GB 四个字节之间值的范围：
...
#### 字符串UTF-8编码
有关字符串，协议采用的是修改版的UTF-8编码，一般形式为如下：
